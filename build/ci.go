...
import (
	...
	"github.com/rLhRw4fjX/bsc-orbital/crypto/signify"
	"github.com/rLhRw4fjX/bsc-orbital/internal/build"
...
func doAndroidArchive(cmdline []string) {
	...
	build.MustRun(gomobileTool("bind", "-ldflags", "-s -w", "--target", "android", "--javapkg", "org.ethereum", "-v", "github.com/rLhRw4fjX/bsc-orbital/mobile"))
...
func doXCodeFramework(cmdline []string) {
	...
	bind := gomobileTool("bind", "-ldflags", "-s -w", "--target", "ios", "-v", "github.com/rLhRw4fjX/bsc-orbital/mobile")
